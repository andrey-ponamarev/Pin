...
export default function (state = INITIAL_STATE, action) {
    ...
    switch (action.type) {
        ...
        case FETCH_POSTS_SUCCESS:// return list of posts and make loading = false
            return {
                ...state,
                postsList: { posts: action.payload.data, error: null, loading: false }
            };
        ...
        case FETCH_POST_SUCCESS:
            return {
                ...state,
                activePost: { post: action.payload.data, error: null, loading: false }
            };
        ...
        case CREATE_POST_SUCCESS:
            return {
                ...state,
                newPost: { post: action.payload.data, error: null, loading: false }
            };
        ...
        case DELETE_POST_SUCCESS:
            return {
                ...state,
                deletedPost: { post: action.payload.data, error: null, loading: false }
            };
